...
@interface YLBAnimationOval ()<YLBAnimationWeakDelegate>
@property(nonatomic,assign)BOOL isPush;
@property(nonatomic,weak)id<UIViewControllerContextTransitioning> transitionContext;

@end

@implementation YLBAnimationOval
...
//    UIBezierPath *endPath       = [UIBezierPath bezierPathWithOvalInRect:CGRectInset(frame, -radius, -radius)];
        UIBezierPath *endPath       = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(-YLB_SCREEN_WIDTH / 4.0, -YLB_SCREEN_HEIGHT / 4.0, YLB_SCREEN_WIDTH * 1.5, YLB_SCREEN_HEIGHT * 1.5)];
...
//    UIBezierPath *startPath     = [UIBezierPath bezierPathWithOvalInRect:CGRectInset(frame, -radiu, -radiu)];
    UIBezierPath *startPath     = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(-YLB_SCREEN_WIDTH / 4.0, -YLB_SCREEN_HEIGHT / 4.0, YLB_SCREEN_WIDTH * 1.5, YLB_SCREEN_HEIGHT * 1.5)];
